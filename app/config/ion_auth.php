 ...
 */
$config['site_title']                 = "Ajensia Retail Solutions";       // Site Title, example.com This is not more functional
$config['admin_email']                = "support@ajensia.com"; // Admin Email, admin@example.com This is not more functional
