...
class Sma
{
    ...
    public function paid_opts($paid_by = null, $purchase = false, $empty_opt = false)
    {
        ...
        $opts .= '
        <option value="cash"' . ($paid_by && $paid_by == 'cash' ? ' selected="selected"' : '') . '>' . 'Cash' . '</option>
        <option value="zaad"' . ($paid_by && $paid_by == 'zaad' ? ' selected="selected"' : '') . '>' . 'Zaad' . '</option>
        <option value="e-dahab"' . ($paid_by && $paid_by == 'e-dahab' ? ' selected="selected"' : '') . '>' . 'E-dahab' . '</option>
        <option value="credit_Card"' . ($paid_by && $paid_by == 'credit_card' ? ' selected="selected"' : '') . '>' . 'Credit Card' . '</option>';
        // $opts .= '
