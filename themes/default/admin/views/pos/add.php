                ...
                <ul class="nav navbar-nav pull-right">
                    <li class="dropdown">
                        <a class="btn account dropdown-toggle" data-toggle="dropdown" href="#">
                            <img alt="" src="<?=$this->session->userdata('avatar') ? base_url() . 'assets/'.$this->session->userdata('tenant_merchant_code').'/uploads/avatars/thumbs/' . $this->session->userdata('avatar') : $assets .$this->session->userdata('tenant_merchant_code').'/images/' . $this->session->userdata('gender') . '.png';?>" class="mini_avatar img-rounded">
        ...
        function printOrder() {
            if (socket.readyState == 1) {
                ...
                if (order_printers == '') {
                    ...
                    'logo': (biller && biller.logo ? site.url+'assets/'.$this->session->userdata('tenant_merchant_code').'/uploads/logos/'+biller.logo : ''),
                    'text': order_data };
