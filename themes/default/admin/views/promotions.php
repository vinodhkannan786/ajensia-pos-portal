...
<head>
    ...
    <title>Ajensia Promotional Page</title>
        ...
        <div class="site-wrapper-inner">
            <div class="cover-container">
                ...
                <div class="inner cover">
                    <h1 class="cover-heading">Ajensia POS</h1>
                    <p class="lead">POS App for small and medium business </p>
                </div>
                <div class="mastfoot">
                    <div class="inner">
                        <p>Ajensia POS by <a href="http://www.ajensia.com">Ajensia</a>.</p>
                    </div>
                </div>
            </div>
        </div>
