...
$(function() {
    ...
    $('#same_as_billing').change(function(e) {
        if ($(this).is(':checked')) {
            $('#shipping_line1')
                .val($('#billing_line1').val())
                .change();
            $('#shipping_line2')
                .val($('#billing_line2').val())
                .change();
            $('#shipping_city')
...
function add_address(address) {
    ...
    if (istates) {
        ...
        astate =
            ...
            '" id="address-state" class="form-control" placeholder="State">';
    }
    swal({
